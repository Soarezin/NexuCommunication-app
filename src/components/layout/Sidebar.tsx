                  ...
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <FolderOpen size={16} /> {client.firstName}{" "}
                        {client.lastName}
                      </div>
                    ...
                    {(client.cases ?? []).length > 0 ? (
                      client.cases.map((lawsuit) => (
                        <Link
                          ...
                          className={`flex items-center gap-2 p-2 rounded-md hover:bg-zinc-200 dark:hover:bg-zinc-700 text-gray-700 dark:text-gray-200 ${
                      ...
                      <p className="text-gray-500 dark:text-gray-400 text-xs pl-2">
                        Nenhum caso.
                      </p>
                    )}
                    <Button
                      variant="ghost"
                      size="sm"
                      className="w-full justify-start text-xs text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300"
                      onClick={() => handleCreateLawsuit(client.id)}
                    >
